...
(function () {
    ...
    setInterval(function(){
        ...
        document.querySelectorAll('.ocean-ui-comments-post-commentholder .ocean-ui-comments-commentbase-entity ').forEach(val=>val.style.backgroundColor = child_color);
    }, 1000);
})();
